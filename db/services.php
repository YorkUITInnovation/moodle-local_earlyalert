...
$functions = [
    ...
    'local_earlyalert_get_course_students_page' => [
        'classname' => 'local_earlyalert_course_grades_ws',
        'methodname' => 'get_course_students_page',
        'classpath' => 'local/earlyalert/classes/external/course_grades_ws.php',
        'description' => 'Returns paged flagged students for selected criteria',
        'type' => 'read',
        'capabilities' => '',
        'ajax' => true,
    ],
    'local_earlyalert_get_course_grade_items' => [
        'classname' => 'local_earlyalert_course_grades_ws',
        'methodname' => 'get_course_grade_items',
        'classpath' => 'local/earlyalert/classes/external/course_grades_ws.php',
        'description' => 'Returns gradebook items for course filtering',
        'type' => 'read',
        'capabilities' => '',
        'ajax' => true,
    ],
    'local_earlyalert_get_student_preview_template' => [
        'classname' => 'local_earlyalert_course_grades_ws',
        'methodname' => 'get_student_preview_template',
        'classpath' => 'local/earlyalert/classes/external/course_grades_ws.php',
        'description' => 'Returns rendered preview subject/body for a student',
        'type' => 'read',
        'capabilities' => '',
        'ajax' => true,
    ],
