...
$functions = array(
    ...
    'earlyalert_ai_execute' => array(
        'classname' => 'local_earlyalert_report_generation_ws',
        'methodname' => 'execute',
        'classpath' => 'local/earlyalert/classes/external/report_generation_ws.php',
        'description' => 'Returns SQL Query generated by AI',
        'type' => 'read',
        'capabilities' => '',
        'ajax' => true
    ),
    'earlyalert_get_table_results' => array(
        'classname' => 'local_earlyalert_report_generation_ws',
        'methodname' => 'get_table',
        'classpath' => 'local/earlyalert/classes/external/report_generation_ws.php',
        'description' => 'Returns HTML table from SQL query',
        'type' => 'read',
        'capabilities' => '',
        'ajax' => true
    ),
