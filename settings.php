...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configyesno('earlyalert_showactivecourses', get_string('showactivecourses', 'local_earlyalert'), get_string('showactivecourses_desc', 'local_earlyalert'), '1'));
