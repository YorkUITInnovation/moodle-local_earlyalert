  ...
  const exportToExcel = () => {
    const exportData = tableFilteredAlerts.map(alert => {
      ...
      return {
        ...
        'Email': alert.email || alert.student?.email || 'N/A',
        ...
        'Transcript Title': alert.transcripttitle || alert.student?.transcripttitle || student.program || 'N/A',
        'Program Faculty': alert.progfaculty || alert.student?.home_faculty || 'N/A',
        'Campus': alert.campus || alert.student?.campus || 'N/A',
        'College Affiliation': alert.collegeaffiliation || alert.student?.collegeaffiliation || 'N/A',
        'College': alert.college || alert.student?.college || 'N/A',
        ...
        'Curriculum Detail': alert.curriculumdetail || alert.student?.curriculumdetail || 'N/A',
        'Subject 1': alert.subject1 || alert.student?.subject1 || 'N/A',
        'Subject 1 Faculty': alert.subject1faculty || alert.student?.subject1faculty || 'N/A',
        'Subject 1 Faculty Desc': alert.subject1facultydesc || alert.student?.subject1facultydesc || 'N/A',
        'Unit 1': alert.unit1 || alert.student?.unit1 || 'N/A',
        'Title 1': alert.title1 || alert.student?.title1 || 'N/A',
        'Subject 2': alert.subject2 || alert.student?.subject2 || 'N/A',
        'Subject 2 Faculty': alert.subject2faculty || alert.student?.subject2faculty || 'N/A',
        'Subject 2 Faculty Desc': alert.subject2facultydesc || alert.student?.subject2facultydesc || 'N/A',
        'Unit 2': alert.unit2 || alert.student?.unit2 || 'N/A',
        'Title 2': alert.title2 || alert.student?.title2 || 'N/A',
        'Basis': alert.basis || alert.student?.basis || 'N/A',
        'Study Level': alert.studylevel || alert.student?.studylevel || student.studylevel || 'N/A',
        'Immigration Status': alert.immigrationstatus || student.immigrationStatus || alert.student?.immigration_status || 'N/A',
        'Visa Flag': alert.visaflag || alert.student?.visaflag || 'N/A',
        'Visa Expiry Date': alert.visaexpirydate || alert.student?.visaexpirydate || 'N/A',
        'Language Correspondence': alert.languagecorrespondence || alert.student?.language_of_correspondence || 'N/A',
        'Mature Flag': alert.matureflag || alert.student?.matureflag || 'N/A',
        'OSAP Flag': alert.osapflag || (student.osapFlag ? 'Y' : 'N') || 'N/A',
        'Varsity Flag': alert.varsityflag || (student.varsityFlag ? 'Y' : 'N') || 'N/A',
        'ESL Flag': alert.eslflag || (student.eslFlag ? 'Y' : 'N') || 'N/A',
        'Scholarship Flag': alert.scholarshipflag || (student.scholarshipFlag ? 'Y' : 'N') || 'N/A',
        'GPA': alert.ogpa || student.ogpa || 'N/A',
        'Latest Academic Decision': alert.latestacademicdecision || alert.academicDecision || student.academicDecision || 'N/A',
        'Academic Decision Term': alert.academicdecisionterm || alert.student?.academicdecisionterm || 'N/A',
        'Academic Status': alert.academicstatus || alert.academicStatus || student.academicStatus || 'N/A'
      };
    });
