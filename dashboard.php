...
$dashboarddata['strings'] = [
    ...
    'choose_alert_type' => get_string('choose_alert_type', 'local_earlyalert'),
     ...
     'alert_criteria_help_title' => get_string('alert_criteria_help_title', 'local_earlyalert'),
     'grade_instructions' => get_string('grade_instructions', 'local_earlyalert'),
     'alert_criteria_help_intro' => get_string('alert_criteria_help_intro', 'local_earlyalert'),
    'alert_criteria_help_view_all_desc' => get_string('alert_criteria_help_view_all_desc', 'local_earlyalert'),
    'alert_criteria_help_filter_on_desc' => get_string('alert_criteria_help_filter_on_desc', 'local_earlyalert'),
    'alert_criteria_help_grade_items_desc' => get_string('alert_criteria_help_grade_items_desc', 'local_earlyalert'),
    'alert_criteria_help_multi_mode_desc' => get_string('alert_criteria_help_multi_mode_desc', 'local_earlyalert'),
    'alert_criteria_help_condition_desc' => get_string('alert_criteria_help_condition_desc', 'local_earlyalert'),
    'alert_criteria_help_threshold_desc' => get_string('alert_criteria_help_threshold_desc', 'local_earlyalert'),
    ...
    'edit_message' => get_string('edit_message', 'local_earlyalert'),
    'save_changes' => get_string('save_changes', 'local_earlyalert'),
    ...
    'cancel' => get_string('cancel', 'local_earlyalert'),
