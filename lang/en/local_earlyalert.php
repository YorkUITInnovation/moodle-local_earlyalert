...
$string['alert_type_assignment_help'] = 'Flag students missing an assignment or quiz submission.';
$string['alert_type_commendation'] = 'Commendation';
$string['alert_type_commendation_help'] = 'Recognize students performing above expectations.';
$string['alert_type_exam_help'] = 'Flag students missing a test or quiz.';
$string['alert_type_low_grade_help'] = 'Flag students below a grade threshold.';
$string['alert_criteria'] = 'Alert Criteria';
$string['apply_filter'] = 'Apply Filter';
$string['back_to_dashboard'] = 'Back to dashboard';
$string['choose_alert_type'] = 'Choose Alert Type';
$string['choose_alert_type_help'] = 'Start by selecting the kind of alert you want to send.';
...
$string['subject_line'] = 'Subject';
$string['message_body'] = 'Message Body';
$string['available_tokens'] = 'Available Tokens';
$string['sample_preview_note'] = 'Sample preview using placeholder values. Final messages are personalized per student at send time.';
$string['resolved_preview'] = 'Resolved eTemplate preview';
$string['resolved_preview_note'] = 'Preview uses the first selected student and the same eTemplate rules used when sending.';
$string['reset_to_template'] = 'Reset to template';
...
$string['flagged_students'] = 'Flagged Students';
...
$string['gradedetails_assignments'] = 'Assignments selected: {$a}';
...
$string['selected_alert_type'] = 'Selected alert type';
$string['alert_criteria_help_title'] = 'Instructions';
$string['alert_criteria_help_intro'] = 'Use these options to control which students are listed in Step 2:';
$string['alert_criteria_help_view_all_desc'] = 'Ignores grade filters and lists all enrolled students.';
$string['alert_criteria_help_filter_on_desc'] = 'Choose overall course grade, one grade item, or multiple grade items.';
$string['alert_criteria_help_grade_items_desc'] = 'Select the assignment, quiz, or test items used for filtering.';
$string['alert_criteria_help_multi_mode_desc'] = 'For multiple items, match students when any selected item meets the threshold, or when the average / weighted average of selected items meets it.';
$string['alert_criteria_help_condition_desc'] = 'Set automatically by alert type (for example, below for low grade, above for commendation, or missing for missed work).';
$string['alert_criteria_help_threshold_desc'] = 'Use a letter-grade range or a typed percentage for the selected condition.';
$string['clear_selection'] = 'Clear Selection';
$string['close'] = 'Close';
$string['export_csv'] = 'Export CSV';
$string['edit_message'] = 'Edit message';
$string['save_changes'] = 'Save changes';
$string['showing_range_default'] = 'Showing 0-0 of 0';
$string['showing_range'] = 'Showing {$a->start}-{$a->end} of {$a->total}';
$string['sort_none'] = 'None';
$string['sort_asc'] = 'Asc';
$string['sort_desc'] = 'Desc';
$string['loading'] = 'Loading...';
$string['message_preview'] = 'Message Preview';
$string['to_label'] = 'To';
$string['metric_pending_actions'] = 'Needs Attention';
$string['metric_students_at_risk'] = 'Students at Risk';
$string['metric_total_alerts'] = 'Total Alerts Sent';
$string['no_students_found'] = 'No students matched the current criteria.';
$string['overall_course_grade'] = 'Overall Course Grade';
...
$string['go_to_page'] = 'Go to page';
$string['of_pages'] = 'of {$a}';
$string['select_grade_item'] = 'Grade item';
$string['select_grade_items'] = 'Grade items';
$string['send_alert_now'] = 'Send Alert';
$string['send_early_alert'] = 'Send an Early Alert';
$string['start_alert_flow'] = 'Start Alert Flow';
$string['student_name'] = 'Student Name';
$string['student_email'] = 'Student email';
$string['threshold'] = 'Threshold';
$string['threshold_mode_letter'] = 'Letter grade range';
$string['threshold_mode_percent'] = 'Typed percentage';
$string['threshold_help'] = 'Choose a letter-grade range or enter an exact percent threshold.';
$string['single_assignment_quiz'] = 'Single assignment / quiz';
$string['multi_assignments_quizzes'] = 'Multiple assignments / quizzes';
$string['multi_mode'] = 'Filter mode';
$string['multi_mode_any'] = 'Any selected item meets threshold';
$string['multi_mode_average'] = 'Average of selected items meets threshold';
$string['multi_mode_weighted'] = 'Weighted average of selected items meets threshold';
$string['unnamed_grade_item'] = 'Unnamed grade item';
...
$string['alert_sent_successfully'] = 'Alert sent successfully';
...
$string['students_contacted'] = 'Students advised';
...
// Advisor View strings
$string['advisor_staff_dashboard'] = 'Advisor & Staff Dashboard';
$string['detailed_student_info_insights'] = 'Detailed student information and actionable insights';
$string['alert_types_click_filter'] = 'Alert Types (Click to Filter)';
$string['intervention_status'] = 'Intervention Status';
$string['filter_options'] = 'Filter Options';
$string['clear_all_filters'] = 'Clear All Filters';
$string['all_campuses'] = 'All Campuses';
$string['all_faculties'] = 'All Faculties';
$string['all_alert_types'] = 'All Alert Types';
$string['all_statuses'] = 'All Statuses';
$string['all_template_types'] = 'All Template Types';
$string['all_student_types'] = 'All Student Types';
$string['based_total_alerts'] = 'Based on total alerts raised';
...
$string['all_study_levels'] = 'All Study Levels';
$string['active_filters'] = 'Active Filters:';
$string['filter_faculty'] = 'Faculty: {$a}';
$string['filter_status'] = 'Status: {$a}';
$string['filter_template'] = 'Template: {$a}';
$string['filter_type'] = 'Type: {$a}';
$string['chart_filter'] = 'Chart Filter: {$a}';
$string['student_alerts_total'] = 'Student Alerts ({$a} total)';
$string['search_placeholder'] = 'Search by student name, email, alert type, or course...';
$string['hide_filters'] = 'Hide Filters';
$string['show_filters'] = 'Show Filters';
$string['export'] = 'Export';
$string['export_count'] = 'Export ({$a})';
$string['student'] = 'Student';
$string['date'] = 'Date';
$string['course'] = 'Course';
$string['send_email'] = 'Send Email';
$string['view_details'] = 'View Details';
$string['showing_first_of_results'] = 'Showing first 50 of {$a} results. Use filters to narrow down the list.';
$string['student_details'] = 'Student Details';
$string['personal_information'] = 'Personal Information';
$string['name'] = 'Name';
$string['email'] = 'Email';
$string['student_id'] = 'Student ID';
$string['immigration_status'] = 'Immigration Status';
