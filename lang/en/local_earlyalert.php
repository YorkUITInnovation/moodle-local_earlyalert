...
$string['build_query'] = 'Query Builder';
...
$string['name'] = 'Name';
$string['new'] = 'New';
$string['preview_results'] = 'Preview Results';
$string['preview_results_help'] = 'You can preview the results of the SQL query generated by the AI. The results will be displayed in a table format.';
$string['prompt'] = 'Prompt';
$string['prompt_help'] = <<<PROMPT_HELP
You can use this field to enter a prompt for the AI to generate a SQL query. The AI will return a query based on the 
prompt you provide.
<p>Available fields:</p>
id int; The id of the reports record. Must always be included as the first column. <br>
sisid varchar; Student ID Number<br>
student_first_name varchar,<br>
student_last_name varchar,<br>
student_email varchar,<br>
faculty longtext,<br>
major longtext,<br>
course_director_idnumber varchar,<br>
course_director_first_name varchar,<br>
course_director_lastname varchar,<br>
course_director_email varchar,<br>
course_full_name varchar,<br>
course_short_name varchar,<br>
course_id_number varchar,<br>
email_subject varchar,<br>
email_message longtext,<br>
email_lang varchar,<br>
user_read bigint,<br>
assignment_name varchar,<br>
trigger_grade bigint,<br>
actual_grade bigint,<br>
student_advised_by_advisor bigint,<br>
student_advised_by_instructor bigint,<br>
date_message_sent bigint<br>
PROMPT_HELP;
$string['requires_course_field'] = 'Requires Course Field';
$string['requires_course_field_help'] = 'If enabled, the query will include the course field in the WHERE statement. 
Furthermore, a course select option will be available on the report page to filter the results by course.';
$string['reset'] = 'Reset';
$string['role'] = 'Role';
$string['role_help'] = 'Who should be able to view this report?';
...
// Reports Settings
$string['reports_settings'] = 'Reports Settings';
$string['reports_tables'] = 'Table definitions';
$string['reports_joins'] = 'Table relationships';
$string['reports_other'] = 'Table instructions';
$string['create_query'] = 'Create Query';
$string['create_query_help'] = 'Click to generate a SQL query from your prompt.';
